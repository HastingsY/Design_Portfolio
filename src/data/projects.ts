...
export const projects: ProjectData[] = [
  {
    ...
    technicalImplementation: {
      designToCodeWorkflow: [
        "• Created interface concepts and information architecture based on software quality stakeholder requirements.",
        "• Implemented reusable React components for score visualizations, quality factor exploration, and benchmark comparisons.",
        "• Developed API integrations with GitHub and GitLab to automatically retrieve assessment outputs and eliminate manual file uploads.",
        "• Translated complex hierarchical JSON structures into interactive visualizations optimized for both technical and non-technical users.",
      ],
      engineeringChallenges: [
        "• Parsing nested quality assessment data structures.",
        "• Designing reusable visualization components.",
        "• Managing asynchronous API requests and data loading states.",
        "• Maintaining usability while presenting large volumes of software quality information.",
      ],
    },
    tools: [
      "React + Vite",
  ...
  },
  {
    ...
    technicalImplementation: {
      designToCodeWorkflow: [
        "• Designed an interactive dashboard architecture to support exploration of hydrologic and environmental monitoring datasets.",
        "• Implemented dynamic filtering, visualization, and data exploration workflows using R Shiny.",
        "• Developed interactive charts and data displays to communicate temporal and spatial environmental patterns.",
        "• Applied user-centered design principles to improve accessibility and interpretation of scientific data.",
      ],
      engineeringChallenges: [
        "• Transforming large environmental datasets into responsive, interactive visualizations.",
        "• Designing intuitive workflows for users with varying levels of technical expertise.",
        "• Balancing scientific accuracy with visual clarity and usability.",
        "• Presenting multidimensional temporal and spatial data in a format that supports efficient decision-making.",
      ],
    },
    tools: [
      "RShiny",
