...
export const projects: ProjectData[] = [
  {
    ...
    challenges:
      "The main challenge was conceptualizing an app that addressed user needs without replicating existing solutions. We incorporated many pain and gain points from our research, which initially added complexity to our design. To overcome this, we reviewed designs from other cooking apps and determined how best to layout the content so that information would not overwhelm users during testing.",
    reflections:
  ...
  },
  {
    ...
    challenges:
      "Balancing clarity for non-technical stakeholders with the depth of information needed by engineers. Designing an interface that could handle complex, nested JSON data while remaining intuitive. Ensuring the comparison view effectively highlighted differences without overwhelming users with information.",
    outcome: {
      content:
